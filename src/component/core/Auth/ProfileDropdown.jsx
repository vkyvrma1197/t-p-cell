    ...
    <button className="relative" onClick={() => setOpen(true)}>
      ...
      {open && (
        <div
          ...
          className="absolute top-[170%] right-0 z-[1000] w-72 divide-y-[1px] divide-richblack-700 overflow-hidden rounded-md border-[1px] border-richblack-700 bg-blue-950"
          ref={ref}
        >
